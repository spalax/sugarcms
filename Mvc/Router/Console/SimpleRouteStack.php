...
namespace Mvc\Router\Console;

use Traversable;
use Mvc\Router\Exception;
use Mvc\Router\Console\RouteInterface;
use Mvc\Router\RouteInterface as BaseRoute;
use Mvc\Router\SimpleRouteStack as BaseSimpleRouteStack;
